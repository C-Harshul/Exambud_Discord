...
mongoose.connect(
  "mongodb+srv://harshul:harshul@cluster0.dbkis.mongodb.net/DeskAssign?retryWrites=true&w=majority",
  {
...
async function addTags(imgUrl, tags) {
  await Pic.find({ url: imgUrl }).then((docs) => {
...
async function getText(url) {
  var apiUrl =
    "https://api.ocr.space/parse/imageurl?apikey=c44024397388957&url=" + url;
  var text = "";
  await axios
    .get(apiUrl)
    .then(async (response) => {
